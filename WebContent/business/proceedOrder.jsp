...
<body>
	...
	<div class="row">
			...
			<!-- ------------订单部分一致的地方------------------- -->
				<div class="allButton">
					<input type="button" value="全部完成" id="allTake">
					<input type="button" value="全部不完成" id="allNotTake">
				</div>
				<hr>
				<div class="order">
					...
					$(data).each(
						function(){
							...
							$(orderRight).append.call($(orderRight),
									...
									span_state);
							let button=$("<div class='takeButton'><input type='button' value='未完成' class='notTake'>"
									+"<input type='button' value='完成' class='take'><div><hr>");
