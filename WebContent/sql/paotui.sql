...
insert  into `admin`(`a_id`,`a_number`,`a_pwd`) values ('666','kolo','123456');
...
CREATE TABLE `business` (
  ...
  `s_telephone` varchar(11) DEFAULT NULL,
  `s_responsible` varchar(20) DEFAULT NULL,
  `s_rPhone` varchar(11) DEFAULT NULL COMMENT '联系人号码',
  `s_province` varchar(10) DEFAULT NULL,
  `s_city` varchar(10) DEFAULT NULL,
  `s_school` varchar(30) DEFAULT NULL,
  `s_address` varchar(100) DEFAULT NULL,
  `s_IdCardPos` varchar(100) DEFAULT NULL,
  `s_IdCardBack` varchar(100) DEFAULT NULL,
  `s_license` varchar(100) DEFAULT NULL,
  `s_hygiene` varchar(100) DEFAULT NULL,
  `s_apply` datetime DEFAULT NULL,
  `s_hours` varchar(40) DEFAULT NULL,
  `s_notReason` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`b_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
insert  into `business`(`b_id`,`b_shopName`,`b_shopLogo`,`b_notice`,`b_accountId`,`b_accountPassword`,`b_commission`,`b_isBan`,`s_type`,`s_stateType`,`s_telephone`,`s_responsible`,`s_rPhone`,`s_province`,`s_city`,`s_school`,`s_address`,`s_IdCardPos`,`s_IdCardBack`,`s_license`,`s_hygiene`,`s_apply`,`s_hours`,`s_notReason`) values ('ggg3','纯情小店铺','ggg1.jpg','小店专卖纯品，有意私聊','sxfowjms',NULL,0.10,0,'1','3','13077569685','kolo',NULL,'广东省','广州市','仲恺农业工程学院','东沙街24号','pos1.jpg','back1.jpg','license1.jpg','','2018-04-04 18:56:38','10:00-22:00',''),('ggg4','麻辣小火锅','ggg2.jpg','有辣有不辣，但辣妹子都会来我这吃辣','qwexca',NULL,0.10,0,'1','3','13077569685','jack',NULL,'广东省','广州市','仲恺农业工程学院','东沙街24号','pos2.jpg','back2.jpg','license2.jpg','','2018-04-19 18:56:41','10:00-22:00',''),('sfd','纯情香锅',NULL,'越吃越纯情','egef',NULL,0.10,0,'1','3','13538428429','mary',NULL,'广西省','桂林市','艺术学院',NULL,NULL,NULL,NULL,NULL,'2018-03-01 00:00:00','10:00-21:00',NULL);
...
LOCK TABLES `remainingsum` WRITE;
