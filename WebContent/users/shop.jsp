...
<html>
	<head>
		...
		<!--<link rel="stylesheet" href="css/shop_css.css" />-->
		...
		<div id="shopframe">
			...
			<div id="head" >
				<div id="cover">
					...
					<div class="shopintro">
						<span class="intro1"><!--<font color="#FFFFFF">-->潮人便当（江南西店）<!--</font>--></span><br /><br />
						<!--<br /><br />
							-->
					</div>
					<!--配送费-->
					<div class="shopintro1">
						<span class="intro2">配送费<br/><br/>&nbsp;&nbsp;￥2</span>
					</div>
					<!--平均送达时间-->
					<div class="shopintro1">
						<span class="intro2">平均送达时间<br/><br/>&nbsp;43分钟送达</span>
					</div>
					<!--收藏-->
					<div class="shopintro1">
						<div id="rst_fav" class="rst-block rst-fav">
							<span class="intro2" data-faved="已收藏" data-unfaved="收藏 餐厅">收藏 餐厅</span>
							<i class="glyph"><span>♥</span></i>
						</div>
					</div>
					<div id="clear"></div>
				</div>
			...
			<div id="shopcontent">
				...
				<div id="goodslist">
					...
					<div class="good">
						...
						<!--商品介绍-->
						<div class="goodintro">
							<span class="intro4">套餐 港记蒜香鸡扒肉酱意粉+柠檬茶</span>
							<span class="intro5">月售19份</span>
	...
	<script type="text/javascript" src="js/rstMenu.2950aa16.js" ></script>
</html>
